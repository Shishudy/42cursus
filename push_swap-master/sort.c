...
/*   Updated: 2023/03/04 20:27:32 by rasantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	send_rest(t_list **a, t_list **b)
{
	...
	while ((*b)->x != last->x)
	{
		if ((*b)->x >= md_pnt)
		{
			printf("HELOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO 11111111111111111\n");
			pa(a, b);
			n++;
		}
		else if ((*b)->x < md_pnt)
	...
	while ((*b) != NULL)
	{
		printf("HELOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO 2222222222222222222\n");
		pa(a, b);
		i++;
	}
	//sort_a(a, b, i);
