...
/*   Updated: 2023/07/07 17:56:40 by rasantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_up(t_game *game, int i)
{
	...
	put_image(game, game->map.player.r_u[i], game->map.player.x, \
	game->map.player.y);
...
void	move_left(t_game *game, int i)
{
	...
	put_image(game, game->map.player.r_l[i], game->map.player.x, \
	game->map.player.y);
	game->map.player.player++;
	ft_printf("Movimentos: %i\n", game->map.player.player - 1);
}
...
void	move_down(t_game *game, int i)
{
	...
	game->map.player.y + 0.74f);
	game->map.player.y = game->map.player.y + 0.25f;
	put_image(game, game->map.player.r_d[i], game->map.player.x, \
	game->map.player.y);
	game->map.player.player++;
	ft_printf("Movimentos: %i\n", game->map.player.player - 1);
}
...
void	move_right(t_game *game, int i)
{
	...
	game->map.player.y + 0.74f);
	game->map.player.x = game->map.player.x + 0.25f;
	put_image(game, game->map.player.r_r[i], game->map.player.x, \
	game->map.player.y);
	game->map.player.player++;
	ft_printf("Movimentos: %i\n", game->map.player.player - 1);
}
